...
public class DemoReguliere {
    ...
    public static void main(String[] args) {
        ...
        int numBlocks = 6;//nombre de blocks
        ...
        VariableHeuristic variableHeuristic1 = new NbConstraintsVariableHeuristic(constraints,true);
        ...
        System.out.println("Configuration Réguliere: \n");
        ...
        BWState<Integer> state = DemoPlanning.makestate(numBlocks ,bw,solution2);
